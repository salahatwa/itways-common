...
public abstract class AbstractCacheStore<K, V> implements CacheStore<K, V> {
	 ...
	 * @param key          key must not be null
	 * @param cacheWrapper cache wrapper must not be null
	 * @return true if the key is absent and the value is set, false if the key is
	 *         present before, or null if any other reason
	 */
	 ...
	 * @param timeout  the key expiry time, if the expiry time is less than 1, the
	 *                 cache won't be expired
